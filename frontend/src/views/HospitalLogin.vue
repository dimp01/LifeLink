  ...
  <div class="auth-page">
    ...
    <div class="auth-panel">
      ...
      <div class="auth-panel-content">
        <h2>Hospital Portal<br/>Access</h2>
        <p>
          Secure access for healthcare professionals — manage organ matching,
          patient records, and transplant coordination.
        </p>
      ...
      <div class="panel-quote">
        "Empowering hospitals with AI-driven organ matching."
      </div>
    </div>
        ...
        <form @submit.prevent="handleLogin">
          <div class="form-group">
            ...
            <input
              v-model="email"
              type="email"
              placeholder="hospital@lifelink.ai"
              required
              autocomplete="email"
            />
          </div>
...
const panelStats = [
  ...
  { value: '10K+', label: 'Transplants' },
  { value: '24/7', label: 'Support' },
]

function updateDocumentTitle() {
  document.title = `Hospital Login – LifeLink AI`
}
...
onMounted(() => {
  updateDocumentTitle()
  if (auth.isLoggedIn && auth.role !== 'hospital') {
    error.value = `You are currently logged in as ${auth.role}. Please log out before switching to hospital.`
  }
})
</script>
